...
namespace AISmartAnalyzer
{
    public partial class SentimentModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("LoggedIn");
            if (labelColumn == null)
            {
                throw new Exception("LoggedIn column not found. Make sure the name searched for matches the name in the schema.");
            }
